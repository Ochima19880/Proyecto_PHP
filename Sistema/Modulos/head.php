...
<head>
    ...
    <!-- Morris Chart Css-->
    <link href="<?php echo URLBASE?><?php echo ESTATICO?>plugins/morrisjs/morris.css" rel="stylesheet" />

    <!-- Custom Css -->
    <link href="<?php echo URLBASE?><?php echo ESTATICO?>css/style.css" rel="stylesheet">

    <!-- AdminBSB Themes. You can choose a theme from css/themes instead of get all themes -->
    <link href="<?php echo URLBASE?><?php echo ESTATICO?>css/themes/all-themes.css" rel="stylesheet" />
</head>